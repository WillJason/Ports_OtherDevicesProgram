...
#define	WriteScratchpad		0x4e		//Ð´ÔÝ´æ´æ´¢Æ÷
#define	ReadScratchpad		0xbe		//¶ÁÔÝ´æ´æ´¢Æ÷
#define	CopyScratchpad		0x48		//¸´ÖÆÔÝ´æ´æ´¢Æ÷
#define	ConvertTemperature	0x44		//ÎÂ¶È±ä»»
#define	RecalEPROM		0xb8		//ÖØÐÂµ÷³ö
#define	ReadPowerSupply	0xb4		//¶ÁµçÔ´
